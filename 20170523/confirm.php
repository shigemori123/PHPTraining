				...
				<table>
					...
					<div>
						<tr>
							...
							<td><p><?php echo $streeAddress; ?></p></td>
						</tr>
					</div>
					<div>
						<tr>
							<td><label>電話番号</label></td>
							<td><p><?php echo $tell1."-".$tell2."-".$tell3; ?></p></td>
						</tr>
					</div>
					<div>
						<tr>
							<td><label>メールアドレス</label></td>
							<td><p><?php echo $mail1."@".$mail2; ?></p></td>
						</tr>
					</div>
					<div>
						<tr>
							<td><label>どこで知ったか</label></td>
							<td><p><p><?= $know1." ".$know2; ?></p></td>
						</tr>
					</div>
					<div>
						<tr>
							<td><label>質問カテゴリ</label></td>
							<td><p><?php echo $questionCategory; ?></p></td>
						</tr>
					</div>
					<div>
						<tr>
							<td><label>質問内容</label></td>
						</tr>
					</table>
					<table>
						<tr>
							<td><text class="nodes" cols=50 rows=10><p><?php echo str_replace("\n","<br>",$question) ?></p></textarea></td>
							</tr>
						</div>
					</table>
				</div>
